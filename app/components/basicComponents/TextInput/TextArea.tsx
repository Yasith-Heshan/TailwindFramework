...
const textareaSuccessClassName =
...
const TextArea = forwardRef<HTMLTextAreaElement, Props>(
  (
    ...
    let textareaBoxClassName = error
      ? textareaErrorClassName
      : success
      ? textareaSuccessClassName
      : textareaDefaultClassName;
    ...
    labelBoxClassName = labelClassName
      ...
      : labelBoxClassName;
    textareaBoxClassName = textareaClassName
      ? textareaClassName + " " + textareaBoxClassName
    ...
    return (
      <div className={`${containerClassName} mb-6 h-24`}>
        ...
        <textarea
          ...
          {...rest}
          id={name}
          className={textareaBoxClassName}
